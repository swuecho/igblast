/* $Id: blast_engine.c 432040 2014-04-09 17:40:19Z fongah2 $
 * ===========================================================================
 *
...
NCBI_XBLAST_EXPORT const int   kBlastPatchVersion = 29;
NCBI_XBLAST_EXPORT const char* kBlastReleaseDate = "December-16-2013";
